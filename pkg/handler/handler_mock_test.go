...
import (
	...
	handler "github.com/JimAlex927/tusd-backend/pkg/handler"
...
func (mr *MockFullUploadMockRecorder) ConcatUploads(ctx, partialUploads interface{}, deletePartFile bool) *gomock.Call {
	mr.mock.ctrl.T.Helper()
